...
$(function () {
  ...
  let wind;
    ...
    // divMap.find('h3').removeClass("look");
      ...
      humidity=$("<td><span>").text("wilgotność: " + citis.current.humidity + " %");
      wind=$("<td><span>").text("wiatr: " + citis.current.wind_kph + " km/h");
      day=$('<td><span>').text("dzień pomiaru: " + citis.location.localtime);
      temp.append(icon);
      tr.append(cityName);
      tr.append(temp);
      tr.append(cloud);
